...
import { createFarmer, getFarmersByLandlord, updateFarmer, deleteFarmer, getFarmers } from "../controllers/farmerController.js";
import authMiddleware from "../middlewares/authMiddleware.js";

const farmerRoute = express.Router();

// farmers Routes
farmerRoute.get("/", authMiddleware, getFarmers);
